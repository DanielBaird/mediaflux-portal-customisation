 ...
 * indents all other lines by four spaces.
 ...
 etc
    $control-size: 2rem;
    $control-border: none;
    $control-active-background: #6be;
    $control-background: transparentize($control-active-background, 0.75);
 ...
 The collection bar
    ...
    $collection-bar-background: $header-background;
    $collection-bar-content-color: $header-content-color;
